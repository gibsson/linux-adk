...
static void show_help(char *name)
{
	printf
	    ("Linux Accessory Development Kit\n\nusage: %s [OPTIONS]\nOPTIONS:\n"
	     ...
	     "If this option is not present, nexus7 \"18d1:4e42\" will be used.\n"
	     "\t-D, --description\n\t\taccessory description. "
	     "If this option is not present, \"Demo ABS2013\" will be used.\n"
	     "\t-m, --manufacturer\n\t\tmanufacturer's name. "
	     "If this option is not present, \"Google, Inc.\" will be used.\n"
	     "\t-M, --model\n\t\tmodel's name. "
	     "If this option is not present, \"DemoKit\" will be used.\n"
	     "\t-n, --vernumber\n\t\taccessory version number. "
	     "If this option is not present, \"1.0\" will be used.\n"
	     "\t-N, --no_app\n\t\toption that allows to connect without an "
	     "Android App (AOA v2.0 only, for Audio and HID).\n"
	     "\t-s, --serial\n\t\tserial numder. "
	     "If this option is not present, \"007\" will be used.\n"
	     "\t-u, --url\n\t\taccessory url. "
	     "If this option is not present, \"https://github.com/gibsson\" will be used.\n"
